...
int main(int argc, char *argv[])
{
    ...
    ros::Subscriber keyboard_cmd_sub =
        nh.subscribe<geometry_msgs::Twist>("keyboard_cmd",
                                           10,
                                           boost::bind(&PX4CtrlFSM::keyboardCmdCallback, &fsm, _1));
    ...
    ROS_INFO("[PX4CTRL] Keyboard control enabled. Launch with:");
    ROS_INFO("  roslaunch px4ctrl keyboard_control.launch");
    ROS_INFO("  Or run: rosrun px4ctrl keyboard_control_node");
    ROS_INFO("Control keys: W/S=前后, A/D=左右, R/F=上下, Q/E=转向, L=降落");
